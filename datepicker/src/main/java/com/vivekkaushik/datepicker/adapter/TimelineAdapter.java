        ...
        holder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedView != null) {
                    selectedView.setBackground(timelineView.getResources().getDrawable(R.drawable.background_default));
...
//                    Log.d("oldposition", Integer.toString(oldPosition));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        boolean bind(int month, int day, int dayOfWeek, int year, int position) {
            ...
            if (selectedPosition == position) {
                ...
                rootView.setBackground(timelineView.getResources().getDrawable(R.drawable.background_default));
            }
